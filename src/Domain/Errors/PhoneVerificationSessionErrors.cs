...
public static partial class PhoneVerificationSessionErrors
{
    ...
    public static readonly Error FailedExpireProcessError = Error.Failure($"{Prefix}.{nameof(FailedExpireProcessError)}", "An error occurred while expiring the OtpSession.");
